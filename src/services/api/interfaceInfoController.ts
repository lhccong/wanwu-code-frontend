...
/** listAdminInterfaceInfoByPage GET /api/interfaceInfo/list/page/admin */
export async function listAdminInterfaceInfoByPageUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listAdminInterfaceInfoByPageUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageInterfaceInfo_>('/api/interfaceInfo/list/page/admin', {
    method: 'GET',
    params: {
      ...params,
    },
