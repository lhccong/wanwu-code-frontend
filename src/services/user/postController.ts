...
/** publishMyPost POST /api/post/publish */
export async function publishMyPostUsingPOST(
  body: API.PostPublishRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/post/publish', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** removePostImg POST /api/post/remove/img */
export async function removePostImgUsingPOST(
  body: API.PostImgRemoveRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/post/remove/img', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
